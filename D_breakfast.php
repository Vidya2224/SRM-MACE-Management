                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="add_breakfast.php" method="POST">
                                        <label>Name : </label>
                                        <input type="text" name="name" placeholder="Enter bhaji name"> <br>
                                        <label>Price : </label>
                ...
                <div style="height:300px;width:200px;overflow:scrollbar;">
                    <table class="table table-success table-striped">
                        ...
                        <tr>
                            ...
                            <td><a href="br_activate.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success">Activate</button></a></td>
                            <td><a href="deactivate_br.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Deactivate</button></a></td>
                        </tr>
