                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="add_bhaji.php" method="POST">
                                        <label>Name : </label>
                                        <input type="text" name="name" placeholder="Enter bhaji name">
                ...
                <div style="height:300px;width:200px;overflow:scrollbar;">
                    <table class="table table-success table-striped">
                        ...
                        <tr>
                            ...
                            <td><a href="activate.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success">Activate</button></a></td>
                            <td><a href="deactivate_b.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Deactivate</button></a></td>
                            <td><a href="delete_r.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Delete</button></a></td>
                        </tr>
