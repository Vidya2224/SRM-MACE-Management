...
function breakfast(){
    include("connect.php");
    $result = mysqli_query($con, "SELECT * FROM breakfast WHERE status='active'");
    return $result;
}
...
<head>
    ...
    <title>Breakfast services</title>
...
<body id="body">
    ...
    <div  id="main">
        <div id="div1">
            ...
            <img src="b1.jpg" alt="" style="border-radius:50%;height: 500px ;width: 500px;border: 5px solid white;">
