...
function display_data(){
    include("connect.php");
    $result = mysqli_query($con, "SELECT * FROM students WHERE type='withoutbreakfast'");
    return $result;
}
?>
...
<head>
    ...
    <title>Student withoutBreakfast List</title>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="add_withoutbreakfast.php" method="POST">
