                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="add_rice.php" method="POST">
                                        <label>Name : </label>
                                        <input type="text" name="name" placeholder="Enter rice name">
                ...
                <div style="height:300px;width:200px;overflow:scrollbar;">
                    <table class="table table-success table-striped">
                        ...
                        <tr>
                            ...
                            <td><a href="r_activate.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success">Activate</button></a></td>
                            <td><a href="deactivate_r.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Deactivate</button></a></td>
